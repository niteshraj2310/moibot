...
async def download(target_file):
    ...
    if target_file.text[0].isalpha() or target_file.text[0] in (
        "/",
        "#",
        "@",
        "!",
...
async def uploadir(udir_event):
    ...
    if udir_event.text[0].isalpha() or udir_event.text[0] in (
        "/",
        "#",
        "@",
        "!",
...
async def upload(u_event):
    ...
    if u_event.text[0].isalpha() or u_event.text[0] in ("/", "#", "@", "!"):
        return
    if u_event.fwd_from:
        return
...
async def uploadas(uas_event):
    ...
    if uas_event.text[0].isalpha() or uas_event.text[0] in (
        "/",
        "#",
        "@",
        "!",
