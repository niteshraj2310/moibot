...
async def fastpurger(purg):
    ...
    if purg.text[0].isalpha() or purg.text[0] in ("/", "#", "@", "!"):
        return
...
async def purgeme(delme):
    ...
    if delme.text[0].isalpha() or delme.text[0] in ("/", "#", "@", "!"):
        return
...
async def editer(edit):
    ...
    if edit.text[0].isalpha() or edit.text[0] in ("/", "#", "@", "!"):
        return
    message = edit.text
...
async def selfdestruct(destroy):
    ...
    if destroy.text[0].isalpha() or destroy.text[0] in ("/", "#", "@", "!"):
        return
